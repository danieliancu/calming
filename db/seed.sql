...
INSERT INTO article_topics (title)
VALUES
  ('Gestionarea anxietatii'),
  ('Somn & relaxare'),
  ('Mindfulness & respiratie'),
  ('Relatii & comunicare');

INSERT INTO articles (slug, title, tag, minutes, hero_image, author, body, is_recommended, topic_id)
VALUES
  ('exercitii-de-respiratie-pentru-calm', 'Exercitii de respiratie pentru calm', 'Mindfulness & respiratie', 5, '/images/calm-breathing.svg', 'Dr. Sarah Mitchell',
   'Respiratia constienta ramane una dintre cele mai accesibile strategii pentru a calma rapid sistemul nervos.\n\nIncepe intr-o pozitie confortabila, cu spatele drept si umerii relaxati. Inspira lent pe nas in patru timpi, simtind cum abdomenul se extinde usor, apoi mentine aerul pret de patru secunde pentru a oferi corpului timp sa proceseze oxigenul.\n\nExpira controlat pe gura in sase timpi, ca si cum ai sufla intr-un pai. Aceasta faza mai lunga de expir ajuta organismul sa activeze raspunsul parasimpatic si sa reduca tensiunea acumulata.\n\nRepeta ciclul de cel putin zece ori dimineata si seara. Daca simti ca gandurile fug, numara timpii in gand sau sincronizeaza exercitiul cu o melodie lenta pentru a ramane atent la ritm.\n\nAdauga respiratia constienta si in momentele de tranzitie: inainte de o sedinta importanta, dupa o conversatie tensionata sau chiar in pauzele scurte de lucru.\n\nNoteaza in jurnalul tau cand ai folosit tehnica si ce efect ai observat. Corelarea respiratiei cu situatiile concrete te ajuta sa identifici tiparele de stres si sa construesti un plan personalizat.',
   1, (SELECT id FROM article_topics WHERE title = 'Mindfulness & respiratie')),
  ('cum-sa-incepi-un-jurnal-al-emotiilor', 'Cum sa incepi un jurnal al emotiilor', 'Gestionarea anxietatii', 7, '/images/mindful-journal.svg', 'Dr. Ioana Radu',
   'Jurnalul emotiilor devine o oglinda onesta care iti arata cum raspunzi la provocarile zilnice.\n\nStabileste un moment fix pentru scris, de preferat la finalul zilei, cand ai o imagine mai clara asupra evenimentelor. Rezerva cinci pana la zece minute si elimina distragerile precum notificari sau ecrane suplimentare.\n\nImparteste pagina in trei coloane: emotia predominanta, contextul in care a aparut si raspunsul tau comportamental sau fizic. Pastreaza limbajul simplu si descriptiv, fara sa judeci ceea ce simti.\n\nLa finalul fiecarei saptamani revizuieste intrarile si cauta tipare: ce persoane, locuri sau activitati declanseaza bucurie, iritare sau oboseala. Foloseste marcaje de culoare sau simboluri pentru a evidentia aceste conexiuni.\n\nInclude si o intrebare de explorare, precum Ce aveam nevoie in acel moment? sau Ce mi-ar fi fost util sa spun? Aceste intrebari stimuleaza auto-compasiunea si te ajuta sa formulezi strategii pentru viitor.\n\nDaca iti place componenta digitala, combina jurnalul clasic cu aplicatii de monitorizare a starii de spirit. Datele vizuale pot completa foarte bine notitele detaliate si iti ofera argumente obiective in discutiile cu terapeutul.',
   1, (SELECT id FROM article_topics WHERE title = 'Gestionarea anxietatii')),
  ('rutina-de-seara-in-4-pasi', 'Rutina de seara in 4 pasi', 'Somn & relaxare', 4, '/images/night-routine.svg', 'Dr. Mihai Popescu',
   'O rutina de seara coerenta transmite corpului ca ziua se incheie si ca urmeaza relaxarea.\n\nPrimul pas este delimitarea a cel putin treizeci de minute pentru deconectare. Seteaza alarma pe telefon pentru a-ti reaminti sa inchizi laptopul si sa reduci luminile puternice.\n\nPasul doi vizeaza corpul: practica intinderi usoare sau cateva minute de respiratie abdominala. Aceste miscari detensioneaza muschii si reduc acumularea de cortizol dupa o zi solicitanta.\n\nPasul trei este dedicat igienei somnului. Evita ecranele si alege activitati cu ritm lent, precum cititul sau ascultarea unei melodii linistitoare. Daca gandurile sunt agitate, noteaza-le intr-un carnet pentru a le elibera temporar.\n\nUltimul pas implica pregatirea mediului. Aeriseste camera, regleaza temperatura si asigura-te ca patul este confortabil. Folosirea unui difuzor cu arome blande, cum ar fi lavanda, poate deveni un semnal olfactiv placut pentru creier.\n\nMonitorizeaza timp de doua saptamani cum te simti dimineata si ajusteaza ritualul in functie de rezultate. Consecventa este mai importanta decat perfectiunea, iar chiar si micile ajustari pot imbunatati calitatea somnului.',
   1, (SELECT id FROM article_topics WHERE title = 'Somn & relaxare')),
  ('calming-comunitate', 'De ce merita sa te implici in comunitate', 'Relatii & comunicare', 6, '/images/community.svg', 'Dr. Andreea Ionescu',
   'Comunitatea Calming este un spatiu sigur unde poti impartasi experiente si poti primi sustinere autentica.\n\nParticiparea activa la discutii te ajuta sa vezi ca provocarile tale nu sunt izolate. Grupurile tematice acopera subiecte precum stresul la locul de munca, echilibrul emotional sau relatiile de familie, astfel incat gasesti rapid persoane cu preocupari similare.\n\nSpecialistii nostri modereaza conversatiile si ofera resurse validate stiintific. Vei primi recomandari de exercitii, raspunsuri la intrebari sensibile si ghidaj pentru cand simti ca ai ramas fara solutii.\n\nInteractiunile regulate creeaza un sentiment de apartenenta. Cand vezi progresul altor membri, apare motivatia de a continua propriile obiceiuri sanatoase, iar rezultatele devin mai vizibile.\n\nPoti contribui si tu cu materiale: noteaza ce tehnici te-au ajutat, ce carti ai descoperit sau ce lectii ai invatat in terapie. Schimbul de perspective transforma comunitatea intr-o biblioteca vie de resurse emotionale.\n\nFa-ti timp o data pe saptamana pentru a raspunde sau a porni o conversatie noua. Consistenta cultivata in comunitate se reflecta ulterior si in modul in care relationezi cu cei dragi.',
   0, (SELECT id FROM article_topics WHERE title = 'Relatii & comunicare')),
  ('ghid-rapid-pentru-jurnal', 'Ghid rapid pentru jurnalul emotiilor', 'Mindfulness & respiratie', 6, '/images/journal-guide.svg', 'Dr. Ioana Radu',
   'Un jurnal emotional bine structurat devine un instrument practic de auto-reflectie si progres personal.\n\nIncepe prin a defini intentia jurnalului: vrei sa monitorizezi stresul, sa urmaresti relatia cu somnul sau sa notezi momentele de recunostinta? Claritatea obiectivului iti va ghida intrebarile.\n\nFoloseste un sablon simplu cu cinci rubrici: data si momentul zilei, emotia predominanta, intensitatea pe o scala de la unu la zece, contextul evenimentului si raspunsul tau. Completeaza rubricile pe scurt, iar la final adauga doua propozitii de reflectie.\n\nLa fiecare sapte zile, reciteste intrarile si evidentiaza situatiile repetitive. Poate descoperi ca anumite conversatii declanseaza anxietate sau ca pauzele active sporesc starea de bine. Identificarea acestor corelatii te ajuta sa iei decizii mai constiente.\n\nIntegreaza jurnalul si in dialogul cu specialistul tau. Trimite-i in avans cateva idei esentiale pentru a folosi timpul din sesiune cat mai eficient.\n\nNu uita sa marchezi reusitele mici, precum zilele in care ai ales o reactie mai calma sau ti-ai formulat nevoile clar. Recunoasterea progresului mentine motivatia pe termen lung.',
   0, (SELECT id FROM article_topics WHERE title = 'Mindfulness & respiratie')),
  ('cum-sa-alegi-psihologul', 'Cum sa alegi psihologul potrivit', 'Gestionarea anxietatii', 8, '/images/choose-psychologist.svg', 'Dr. Mihai Popescu',
   'Gasirea psihologului potrivit incepe cu o analiza a propriilor obiective.\n\nScrie intr-un carnet ce doresti sa obtii din terapie: poate vrei sa gestionezi mai bine anxietatea, sa imbunatatesti relatia cu partenerul sau sa procesezi un eveniment dificil. Claritatea scopului iti va orienta cautarile catre specializarea adecvata.\n\nInformeaza-te despre formarea profesionala a specialistului si intreaba despre metodele folosite. Terapia cognitiv comportamentala, abordarea integrativa sau terapia de familie au structuri si ritmuri diferite.\n\nStabileste de la inceput aspectele logistice: frecventa sedintelor, disponibilitatea pentru intalniri online, onorariul si politicile de anulare. Un cadru clar reduce riscul de neintelegeri si iti ofera predictibilitate.\n\nIn timpul primei sesiuni observa cum te simti in prezenta psihologului: te simti ascultat, validat si incurajat sa explorezi profund? Relatia terapeutica este un factor esential pentru progres.\n\nReevalueaza colaborarea dupa primele patru sedinte. Daca nu observi niciun semn de avans sau nu te simti confortabil, da-ti permisiunea sa cauti o alta potrivire. Procesul terapeutic este personal si merita sa investesti timp in alegerea corecta.',
   0, (SELECT id FROM article_topics WHERE title = 'Gestionarea anxietatii'));
