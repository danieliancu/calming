...
<head>
    <meta charset="utf-8">
    <title>Mesaj nou de la echipa Calming</title>
</head>
<body style="font-family: Arial, sans-serif; color: #0f172a; line-height: 1.6; background: #f8fafc; margin: 0; padding: 24px;">
    <div style="max-width: 640px; margin: 0 auto; background: #ffffff; border-radius: 16px; padding: 24px; border: 1px solid #e5e7eb;">
        ...
        <p>Ai primit un mesaj nou de la echipa Calming în contul tau de specialist.</p>
        ...
        @if ($dashboardUrl)
            ...
            <p style="font-size: 13px; color: #64748b;">Dacă butonul nu funcționează, deschide acest link: <a href="{{ $dashboardUrl }}">{{ $dashboardUrl }}</a></p>
        @endif
